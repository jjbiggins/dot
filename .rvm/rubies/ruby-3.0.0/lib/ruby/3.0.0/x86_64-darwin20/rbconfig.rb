...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/jjbiggins/.rvm/rubies/ruby-3.0.0")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/jjbiggins/.rvm/rubies/ruby-3.0.0' '--disable-install-doc' '--enable-shared' 'CC=gcc' 'CFLAGS=-O3 -I/opt/local/include' 'LDFLAGS=-L/opt/local/lib'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/Users/jjbiggins/.rvm/rubies/ruby-3.0.0"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-L/opt/local/lib -Wl,-undefined,dynamic_lookup -Wl,-multiply_defined,suppress"
  CONFIG["ALLOCA"] = ""
  ...
  CONFIG["CP"] = "cp"
  CONFIG["RM"] = "rm -f"
  CONFIG["EGREP"] = "/opt/local/bin/ggrep -E"
  CONFIG["GREP"] = "/opt/local/bin/ggrep"
  ...
  CONFIG["LDFLAGS"] = "-L. -L/opt/local/lib -fstack-protector-strong -L/usr/local/lib"
  CONFIG["CFLAGS"] = "-O3 -I/opt/local/include -fno-common -pipe"
  ...
  CONFIG["build"] = "x86_64-apple-darwin20.6.0"
